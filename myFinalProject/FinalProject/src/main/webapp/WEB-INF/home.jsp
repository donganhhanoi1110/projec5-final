						...
						<div id="content-table-inner">
							...
							<div id="hide">
								<table border="0" width="100%" cellpadding="0" cellspacing="0">
											...
											<form action="createAccount.html" method="post">
												<table border="0" cellpadding="0" cellspacing="0"
													...
													<tr>
														...
														<td><select id="selectAccountType" name="accountType">
									...
									<tr>
										<td><form action="addCard.html">
												<input type="submit" class="btnAdd" value="New Card"
													id="newCard" />
											</form></td>
										<td><form action="makeNewTransfer.html">
												<input type="submit" class="btnAdd" value="Make a Transfer"
													id="newCard" width="50px" />
											</form></td>
									</tr>
								</table>
							</div>
