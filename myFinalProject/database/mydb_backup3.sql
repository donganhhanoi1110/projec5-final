...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2015 at 05:48 AM
...
(123456, 'saving', 'Minh', 'Nguyen', 'Anh', '024939082', 1699988263, 1699988263, 'Bui Dinh Tuy', 'Bui Dinh Tuy', 'minh@gmail.com', 'active', 1);
...
INSERT INTO `interestrate` (`id`, `savingaccout_type`, `interest_rate`, `currency`) VALUES
(2, '3 months', 6, 'VND'),
(3, '0 month', 0.5, 'VND');
...
INSERT INTO `savingaccount` (`id`, `customer_id`, `balance_amount`, `repeatable`, `interest_rate_id`) VALUES
(2, 1, 20000, 0, 2);
...
INSERT INTO `transaction` (`id`, `amount`, `date_start`, `date_end`, `saving_account_id`, `state`) VALUES
(1, 30000, '20/1/2015', '20/1/2015', 2, 'hold'),
(2, 10000, '20/1/2015', '20/1/2015', 2, 'hold'),
(3, 21000, '20/1/2015', '20/1/2015', 2, 'hold'),
(13, 10000, '10000', '10000', 2, 'new');
