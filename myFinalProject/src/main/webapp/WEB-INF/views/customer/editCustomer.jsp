												...
												<c:forEach var="cust" items="${customerProfile}">
													<tr>
														...
														<td><input type="hidden" class="inp-form"
															name="custID" value="${cust.id}" /> ${cust.id}</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td><input type="text" class="form-control"
															name="add1" value="${cust.add1}" /></td>
													</tr>
													<tr>
														<th valign="top">Address 2</th>
														<td><input type="text" class="form-control"
															name="add2" value="${cust.add2}" /></td>
													</tr>
													<tr>
														<th valign="top">Mail:</th>
														<td><input type="text" class="form-control"
															name="email" value="${cust.email}" /></td>
													</tr>
													<tr>
														<th valign="top">State:</th>
														<td><input type="text" class="form-control"
															name="state" value="${cust.state}" /></td>
													</tr>
															<tr>
