...
public class CustomerDAO {
	...
	public List<Customer> getAllCustomer(){
		...
		try{
			TypedQuery<Customer> query = entityManager.createQuery("SELECT C FROM "
					+ Customer.class.getName() + " C", Customer.class);
	...
	public Customer getCustomerId(int id){
		...
		try{
			...
			System.out.println("\nGetting customer has error"+"*_"+ e.getMessage());
		}
	...
	public boolean updateCustomer(Customer cust){
		...
		try{
			...
			System.out.println("\nUpdate customer get Error "+ "*_"+e.getMessage()+"*_");
		}
		return check;
	}
	...
	public boolean createCust(Customer cust){
		...
		try{
			...
			System.out.println("\n Get error with create customer:" +e.getMessage());
		}
		return check;
	}
	...
	public boolean deleteCustomerById(int CustId){
		...
		try{
			...
			if(cust==null){
				check=false;
				throw new EntityNotFoundException("Can't find Customer for ID " + CustId);
			}
			if(cust!=null){
				...
				System.out.println("\nDelete Customer by ID get Error "+ "*_"+e.getMessage()+"*_");
			}
		return check;
		}
	}
